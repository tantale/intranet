...
<%def name="main_menu()">\
    ...
    <ul class="menu">
      ...
      <li><a>Administration</a>
        <ul>
          <li><a href="${tg.url('/admin/employee/index.html')}"><span
            class="ui-icon ui-icon-person"></span>Gestion des employés</a></li>
          <li><a href="${tg.url('/admin/order/index.html')}"><span
      ...
      <li><a>Pointage</a>
        <ul>
          <li><a href="${tg.url('/pointage/trcal/index.html')}"><span
            class="ui-icon ui-icon-calendar"></span>Calendrier de pointage</a></li>
        </ul></li>
      <li><a>Outils</a>
        <ul>
          <li><a href="${tg.url('/tools/fix_bad_centuries/')}"><span
            class="ui-icon ui-icon-wrench"></span>${_(u"Diagnostique les dates trop petites")}</a></li>
        </ul></li>
    </ul>
</%def>
